...
CREATE TABLE `booking_offers` (
  ...
  CONSTRAINT `booking_offers_ibfk_1` FOREIGN KEY (`original_booking_id`) REFERENCES `bookings` (`booking_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `booking_offers_ibfk_2` FOREIGN KEY (`alternative_apartment_id`) REFERENCES `apartments` (`apartment_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `booking_offers_ibfk_3` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`tenant_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `booking_offers_ibfk_4` FOREIGN KEY (`created_by_staff_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE RESTRICT
);
